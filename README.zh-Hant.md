...
> 純標準函式庫核心，八個可執行工具，九個真實模型配接器置於
> Protocol 契約之後，三份文件語系，239 個測試，30 項後端完整性檢查。
...
[![PyPI](https://img.shields.io/badge/PyPI-mrnavax%200.20.0-blue?logo=pypi&logoColor=white)](https://pypi.org/project/mrnavax/)
